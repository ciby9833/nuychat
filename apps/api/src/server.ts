...
import { createSlaWorker } from "./workers/sla.worker.js";
import { createTaskEngineWorker } from "./workers/task-engine.worker.js";
import { createTaskPublisherWorker } from "./workers/task-publisher.worker.js";
import { createTaskSchedulerWorker } from "./workers/task-scheduler.worker.js";
...
const taskSchedulerWorker = createTaskSchedulerWorker();
const taskEngineWorker = createTaskEngineWorker();
const taskPublisherWorker = createTaskPublisherWorker();
...
try {
  ...
  await taskSchedulerWorker.close();
  await taskEngineWorker.close();
  await taskPublisherWorker.close();
