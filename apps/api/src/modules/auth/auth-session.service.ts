...
const AGENT_PROFILE_ROLES = new Set(["agent", "senior_agent", "supervisor"]);
...
export function roleUsesAgentProfile(role: string | null | undefined): boolean {
  return typeof role === "string" && AGENT_PROFILE_ROLES.has(role);
}
