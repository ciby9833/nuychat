 ...
 * 功能名称: 工作台侧边栏
 * 菜单路径: 座席工作台 / 全局导航
 * 文件职责: 提供首页、消息、任务三大入口，并展示未读消息与任务数量角标。
 * 交互页面:
...
export type WorkspaceSection = "home" | "messages" | "tasks";
...
export function WorkspaceSidebar({ section, unreadCount, taskCount, onNavigate }: WorkspaceSidebarProps) {
