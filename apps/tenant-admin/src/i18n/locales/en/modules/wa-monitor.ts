export default {
  waMonitor: {
    ...
    reportTabs: {
      ...
      accounts: "By WA Account",
      members: "By Agent",
      time: "By Time",
      messages: "Message Detail",
      unreplied: "Unreplied Detail"
    },
    report: {
      title: "Daily Report / {{date}}",
      totalMessages: "Total Messages",
      customerMessages: "Customer Messages",
      serviceMessages: "Agent Messages",
      manualReplies: "Manual Replies",
      requiresReply: "Needs Reply",
      replied: "Replied",
      unreplied: "Unreplied",
      avgResponse: "Average Response Time",
      accountReport: "By WA Account",
      memberReport: "By Agent",
      account: "Account",
      member: "Agent",
      ...
      firstReplyText: "First Reply Content",
      yes: "Yes",
      no: "No",
      customerMessageAt: "Customer Message Time",
      timeBucket: "Time",
      byHour: "Hourly",
      byDay: "Daily",
      exportExcel: "Export Excel",
      paginationTotal: "{{count}} total",
      monitoredConversations: "Monitored Conversations",
      firstReplies: "First Replies",
      avgFirstReply: "Avg First Reply",
      participatedConversations: "Participated Conversations",
