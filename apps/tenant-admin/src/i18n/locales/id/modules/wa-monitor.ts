export default {
  waMonitor: {
    ...
    reportTabs: {
      health: "Kesehatan Akun",
      accounts: "Per Akun WA",
      members: "Per Agen",
      time: "Per Waktu",
      messages: "Detail Pesan",
      unreplied: "Detail Belum Dibalas"
    },
    report: {
      title: "Laporan Harian / {{date}}",
      totalMessages: "Total pesan",
      customerMessages: "Pesan pelanggan",
      serviceMessages: "Pesan agen",
      manualReplies: "Balasan manual",
      requiresReply: "Perlu dibalas",
      replied: "Sudah dibalas",
      unreplied: "Belum dibalas",
      avgResponse: "Rata-rata waktu respons",
      accountReport: "Per Akun WA",
      memberReport: "Per Agen",
      account: "Akun",
      member: "Agen",
      ...
      context: "Konteks",
      agent: "Agen",
      analysisReason: "Alasan",
      confidence: "Keyakinan",
      firstReplyAt: "Waktu Balasan Pertama",
      firstReplyText: "Isi Balasan Pertama",
      yes: "Ya",
      no: "Tidak",
      customerMessageAt: "Waktu Pesan Pelanggan",
      timeBucket: "Waktu",
      byHour: "Per Jam",
      byDay: "Per Hari",
      exportExcel: "Ekspor Excel",
      paginationTotal: "Total {{count}}",
      monitoredConversations: "Percakapan dipantau",
      firstReplies: "Balasan pertama",
      avgFirstReply: "Rata-rata balasan pertama",
      participatedConversations: "Percakapan diikuti",
